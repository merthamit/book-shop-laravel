...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            @endif
            <form action="{{ route('hero.update') }}" method="POST" id="myForm">
                @csrf
                <div class="card">
                        ...
                        <div class="row">
                            <div class="col-md-6 col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="header_big" class="form-control" id="header"
                                        placeholder="Büyük header giriniz." value="{{ $hero->header_big }}" />
                            ...
                            <div class="col-md-6 col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="header_medium" class="form-control" id="medium_header"
                                        placeholder="Orta header giriniz." value="{{ $hero->header_medium }}" />
                                    <small id="emailHelp2" class="form-text text-muted">We'll never share your email with
                                        anyone
                                        else.</small>
                                </div>
                            ...
                            <div class="col-md-6 col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="button_name" class="form-control" id="header"
                                        placeholder="Büyük header giriniz." value="{{ $hero->button_name }}" />
                                    <small id="emailHelp2" class="form-text text-muted">We'll never share your email with
                                        anyone
                                        else.</small>
                                </div>
                            ...
                            <div class="col-md-6 col-lg-4">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="header_small" id="comment" rows="5" spellcheck="false">{{ $hero->header_small }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
